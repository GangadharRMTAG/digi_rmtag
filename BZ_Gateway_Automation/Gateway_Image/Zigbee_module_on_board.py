...
def login_and_configure_time_interval(playwright, deviceID):
    ...
    page.get_by_role("textbox", name="Enter Command").fill("C20407014501")
    page.get_by_role("button", name="save").click()

def test_ZigbeeModuleOnBoard(serial_connection, record_property):
    ...
    send_cli_command(ser, 'zpinfo', wait=2)
