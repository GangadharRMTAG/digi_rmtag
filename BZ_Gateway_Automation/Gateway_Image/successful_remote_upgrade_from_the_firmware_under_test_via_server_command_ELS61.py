...
def login_and_configure_time_interval(playwright, deviceID):
    ...
    page.get_by_role("textbox", name="Enter Command").fill("C010")
    page.get_by_role("button", name="save").click()

def test_ELS61SuccessfulRemoteUpgradeToTheFirmwareUnderTestViaServerCommand(serial_connection, record_property):
